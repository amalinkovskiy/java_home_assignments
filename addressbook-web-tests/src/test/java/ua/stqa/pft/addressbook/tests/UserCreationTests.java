...
public class UserCreationTests extends TestBase {
    ...
    public void testUserCreation() {
        ...
        app.getUserHelper().fillFormWithData(new UserData("Alexander", "B", "Malinkovskiy", "amalinkovskiy", "title", "company", "address", "home", "(777)777-88-99", "work", "fax", "a@a.a", "test1"), true);
